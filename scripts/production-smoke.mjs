...
assert.match(app, /path="\/dashboard\/admin"/, "Super Admin dashboard route must exist");
assert.match(app, /allowedRoles=\{\["super_admin"\]\}/, "Super Admin dashboard must be role protected");
