...
export const INITIAL_HABITS: Habit[] = [
  {
    ...
    description:
      "Melaksanakan ibadah di awal hari dengan khusyuk dan membaca doa kelancaran belajar.",
    points: 50,
  ...
  },
  {
    ...
    description:
      "Lakukan senam ringan, jalan kaki, atau peregangan tubuh minimal 15 menit.",
    points: 40,
    timeTarget: "05.30 - 06.00 WIB",
    iconName: "Dumbbell",
    bgPastel:
      "bg-emerald-50/90 hover:bg-emerald-100/90 text-emerald-900 border-emerald-200",
  ...
  },
  {
    ...
    description:
      "Makan makanan bernutrisi seimbang dan minum 2 gelas air putih sebelum berangkat.",
    points: 30,
  ...
  },
  {
    ...
    description:
      "Melipat selimut, merapikan bantal, dan membersihkan kamar sendiri.",
    points: 35,
    timeTarget: "06.15 - 06.45 WIB",
    iconName: "Bed",
    bgPastel:
      "bg-indigo-50/90 hover:bg-indigo-100/90 text-indigo-900 border-indigo-200",
  ...
  },
  {
    ...
    description:
      "Membaca buku pelajaran, novel sains, atau bacaan edukatif di luar jam sekolah.",
    points: 60,
    timeTarget: "16.00 - 17.00 WIB",
    iconName: "BookOpen",
    bgPastel:
      "bg-purple-50/90 hover:bg-purple-100/90 text-purple-900 border-purple-200",
  ...
  },
  {
    ...
    description:
      "Membantu menyapu rumah, mencuci piring, atau menjaga adik dengan ikhlas.",
    points: 45,
    timeTarget: "17.00 - 18.00 WIB",
    iconName: "HeartHandshake",
    bgPastel:
      "bg-rose-50/90 hover:bg-rose-100/90 text-rose-900 border-rose-200",
  ...
  },
  {
    ...
    description:
      "Mengulang materi pelajaran esok hari serta membaca Al-Quran/Kitab Suci.",
    points: 50,
    timeTarget: "19.00 - 20.30 WIB",
    iconName: "GraduationCap",
    bgPastel:
      "bg-teal-50/90 hover:bg-teal-100/90 text-teal-900 border-teal-200",
...
export const INITIAL_HISTORIES: ActivityHistory[] = [
  {
    ...
    initiative: "Sadar Sendiri",
    reflection:
      "Bangun tepat waktu jam 04.20. Melaksanakan salat berjamaah di masjid kompleks.",
    comments: [
      {
        id: "c-101",
        ...
        content:
          "Luar biasa Rizky! Konsistensi bangun subuh mandiri ini menjadi teladan yang baik untuk kawan-kawan di kelas. Pertahankan ya!",
        timestamp: "06.10 WIB",
      },
      {
        id: "c-102",
        ...
        content:
          "Terima kasih banyak Ibu Maya! Saya juga dibantu oleh alarm buatan sendiri dan pengingat dari ibu di rumah.",
        timestamp: "06.25 WIB",
      },
    ],
  },
  {
    ...
    initiative: "Sadar Sendiri",
    reflection:
      "Jumping jack 20x, push up 15x, dan jogging pendek di halaman rumah.",
    comments: [
      {
        id: "c-201",
        senderName: "Ibu Maya Indriani, S.Pd.",
        ...
        avatarBg: "from-amber-400 to-rose-400 border-amber-300",
        content:
          "Bagus sekali! Olahraga sebelum jam sekolah membuat pikiran lebih fokus saat menerima pelajaran jam pertama.",
        timestamp: "07.00 WIB",
      },
    ],
  },
  {
    ...
    initiative: "Sadar Sendiri",
    reflection:
      "Membaca bab 4 tentang Tata Surya di buku Sains Populer Remaja. Menemukan fakta menarik tentang Planet Yupiter.",
    comments: [
      {
        id: "c-301",
        senderName: "Ibu Maya Indriani, S.Pd.",
        ...
        avatarBg: "from-amber-400 to-rose-400 border-amber-300",
        content:
          "Wah menarik sekali! Nanti saat jam pembelajaran IPA, Rizky boleh berbagi cerita singkat tentang Yupiter ke depan kelas ya.",
        timestamp: "18.15 WIB",
      },
      {
        id: "c-302",
        ...
        avatarBg: "from-sky-400 to-indigo-500 border-sky-300",
        content:
          "Siap Bu Maya, saya sudah membuat rangkuman poin utamanya di buku catatan!",
        timestamp: "19.05 WIB",
      },
    ],
  },
  {
    ...
    initiative: "Disuruh",
    reflection:
      "Disuruh ibu menyapu ruang tamu dan membuang sampah ke tempat penampungan luar.",
    comments: [
      {
        id: "c-401",
        senderName: "Ibu Maya Indriani, S.Pd.",
        ...
        avatarBg: "from-amber-400 to-rose-400 border-amber-300",
        content:
          "Tetap patut diapresiasi Rizky! Langkah awal dari disuruh nantinya akan menjadi kebiasaan sadar sendiri. Semangat!",
        timestamp: "20.00 WIB",
      },
    ],
  },
...
export const INITIAL_BADGES: BadgeItem[] = [
  {
    ...
    description:
      "Berhasil menyelesaikan ibadah & persiapan pagi sebelum pukul 06.00 WIB selama 7 hari berturut-turut.",
    iconName: "Sun",
    isUnlocked: true,
  ...
  },
  {
    ...
    category: "Edukasi",
    description:
      "Membaca buku non-pelajaran lebih dari 300 menit dalam kurun waktu satu bulan.",
    iconName: "BookOpen",
    isUnlocked: true,
  ...
  },
  {
    ...
    category: "Karakter",
    description:
      'Mengisi 20 kebiasaan harian dengan inisiatif "Sadar Sendiri" tanpa perlu diingatkan.',
    iconName: "Sparkles",
    isUnlocked: true,
  ...
  },
  {
    ...
    description:
      "Mempertahankan streak kebiasaan harian tanpa putus selama 30 hari berturut-turut.",
    iconName: "Flame",
    isUnlocked: false,
  ...
  },
  {
    ...
    description:
      "Membantu orang tua di rumah sebanyak 15 kali dalam kurun waktu dua minggu.",
    iconName: "HeartHandshake",
    isUnlocked: false,
  ...
  },
  {
    ...
    description:
      "Berhasil menduduki peringkat Top 3 dalam leaderboard angkatan sekolah.",
    iconName: "Trophy",
    isUnlocked: false,
...
export const INITIAL_CERTIFICATES: CertificateItem[] = [
  {
    ...
    description:
      "Diberikan kepada Ahmad Rizky atas dedikasi dan konsistensi tinggi dalam menerapkan kebiasaan positif harian dengan inisiatif mandiri secara berkelanjutan.",
  },
  {
    id: "cert-2",
    ...
    description:
      "Penghargaan atas keaktifan luar biasa dalam pembiasaan salat subuh, olahraga pagi, dan kerapian diri tanpa pernah terputus.",
  },
];
