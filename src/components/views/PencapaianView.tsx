...
export const PencapaianView: React.FC<PencapaianViewProps> = ({ badges, awards, certificates, streak }) => {
    ...
    <div className="space-y-8 animate-fade-in pb-12">
      <div className="bg-gradient-to-r from-amber-400 via-yellow-400 to-orange-400 rounded-[2.5rem] p-6 md:p-8 lg:p-10 border-4 border-white shadow-2xl shadow-amber-200/80 text-slate-950 flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
        <div className="space-y-2 relative z-10 max-w-xl">
          ...
          <h2 className="text-3xl md:text-4xl font-black tracking-tight text-slate-950 font-heading">Pencapaianmu! 🏆</h2>
        ...
        <div className="flex items-center gap-4 bg-white/40 backdrop-blur-md p-4 rounded-3xl border-2 border-white/80 shadow-lg relative z-10">
          <div className="w-16 h-16 rounded-2xl bg-white p-2 flex items-center justify-center shadow-md border-2 border-amber-300">
      ...
      {/* Streak */}
      <section className="bg-white rounded-[2rem] p-6 md:p-7 border-4 border-white shadow-xl shadow-amber-100/70">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-5">
          ...
          <div className="flex gap-3 flex-wrap">
            <div className="rounded-2xl bg-orange-50 border border-orange-200 px-4 py-3"><p className="text-[10px] uppercase font-black text-orange-600">Streak Saat Ini</p><p className="text-2xl font-black text-orange-900">{streak.current} hari</p></div>
            <div className="rounded-2xl bg-sky-50 border border-sky-200 px-4 py-3"><p className="text-[10px] uppercase font-black text-sky-600">Rekor Terbaik</p><p className="text-2xl font-black text-sky-900">{streak.best} hari</p></div>
            <div className="rounded-2xl bg-emerald-50 border border-emerald-200 px-4 py-3"><p className="text-[10px] uppercase font-black text-emerald-600">Kesempatan Bulan Ini</p><p className="text-2xl font-black text-emerald-900">{streak.remainingChances}/{streak.maxMonthlyChances}</p></div>
          </div>
        </div>
