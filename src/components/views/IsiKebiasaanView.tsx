...
export const IsiKebiasaanView: React.FC<IsiKebiasaanViewProps> = () => {
  ...
  return <div className="space-y-7 animate-fade-in pb-12">
    ...
    <section className="grid grid-cols-1 lg:grid-cols-[1.35fr_.65fr] gap-6 items-start">
      <div className="min-w-0 bg-white rounded-[2rem] p-5 sm:p-6 md:p-7 shadow-xl shadow-sky-100/60">
