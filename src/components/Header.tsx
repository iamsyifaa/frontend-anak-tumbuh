...
export const Header: React.FC<HeaderProps> = ({ isMobileOpen, setIsMobileOpen, activeTab }) => {
  ...
  return (
    <header className="absolute top-0 left-0 w-full z-30 bg-transparent px-3 sm:px-4 md:px-8 py-3 sm:py-4 md:py-6 flex items-center justify-between pointer-events-none">
      <div className="ml-auto">
      <div className="flex items-center gap-1 sm:gap-3 bg-white rounded-[1.5rem] sm:rounded-[2rem] px-1.5 sm:px-4 py-1 sm:py-2 shadow-[0_4px_20px_rgba(186,230,253,0.4)] border border-white pointer-events-auto ml-auto">
