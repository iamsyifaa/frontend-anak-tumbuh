...
import { AlertCircle, CheckCircle2, FileSpreadsheet, Loader2, Plus, RefreshCw, Search, UserRound, X } from "lucide-react";
...
export const TeacherManagementPage: React.FC = () => {
  ...
  return <div className="space-y-5">
    ...
    {importOpen && user && schoolId && <TeacherImportWizard user={user} schoolId={schoolId} groups={groups} onClose={()=>setImportOpen(false)} onCommitted={async ()=>{setImportOpen(false); await load(); setNotice("Import guru berhasil diproses.");}}/>} 
  </div>;
};
