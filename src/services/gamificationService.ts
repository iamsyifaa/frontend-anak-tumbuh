...
const badges: BadgeItem[] = INITIAL_BADGES.map((badge) =>
  badge.id === "badge-4"
    ? {
        ...
        description:
          "Mencapai target pengisian kebiasaan yang ditetapkan sekolah pada 30 hari terpilih.",
        iconName: "Calendar",
...
const certificates: CertificateItem[] = INITIAL_CERTIFICATES.map(
  (certificate) => ({
    ...certificate,
    description:
...
const awards = [
  {
    ...
    description:
      "Penghargaan atas pencapaian target kebiasaan mandiri pada periode Juli 2026.",
  ...
  },
  {
    ...
    description:
      "Penghargaan berdasarkan pencapaian target kebiasaan belajar pada periode minggu pertama Agustus.",
